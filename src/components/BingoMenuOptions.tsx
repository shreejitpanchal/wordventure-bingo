...
const PLAYER_OPTIONS = [
  { id: 1, label: 'Solo vs. Computer', emoji: '🧑' },
  { id: 2, label: 'Pass & Play (2)', emoji: '🧑‍🤝‍🧑' },
] as const;
...
export default function BingoMenuOptions({ config, sound, reduceMotion, onChange }: ModeMenuOptionsProps<GameConfig, Streaks>) {
  return (
    <>
      <OptionSection
        title="Players"
